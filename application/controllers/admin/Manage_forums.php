...
class Manage_forums extends CI_Controller
{
    ...
    public function category_create()
    {
      ...
      $this->form_validation->set_rules('category_name', 'lang:forums_name', 'required|trim|strip_tags|is_unique[forums_categories.name]');
      $this->form_validation->set_rules('category_slug', 'lang:forums_slug', 'required|trim|strip_tags|alpha_dash|is_unique[forums_categories.slug]');
      $this->form_validation->set_rules('category_parent', 'lang:forums_parent', 'required|trim|integer');
    	...
    	if($this->form_validation->run())
    	{
    	    ...
    	    //@todo check that the input was accepted
    ...
    public function category_edit($category_id)
    {
      ...
      $this->form_validation->set_rules('category_name', 'lang:forums_name', 'required|trim|strip_tags|is_unique[forums_categories.name]');
      $this->form_validation->set_rules('category_slug', 'lang:forums_slug', 'required|trim|strip_tags|alpha_dash|is_unique[forums_categories.slug]');
      $this->form_validation->set_rules('category_parent', 'lang:forums_parent', 'trim|integer');
    ...
    public function thread_edit($thread_id)
    {
      ...
      //validate data
      $this->form_validation->set_error_delimiters('<div class="alert alert-danger">', '</div>');
      $this->form_validation->set_rules('thread-title', 'lang:forums_name', 'required|trim|strip_tags|is_unique[forums_categories.name]');
      $this->form_validation->set_rules('thread-slug', 'lang:forums_slug', 'required|trim|strip_tags|alpha_dash|is_unique[forums_categories.slug]');
      $this->form_validation->set_rules('thread-category', 'lang:forums_parent', 'required|trim|integer');
