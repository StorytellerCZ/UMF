...
class Message extends CI_Controller
{
    ...
    function index($id = NULL)
    {
        ...
        if($this->input->post('msg-reply', TRUE))
        {
            ...
            $this->form_validation->set_rules('msg-reply-id', 'lang:pm_reply', 'required|trim|numeric');
            $this->form_validation->set_rules('msg-subject', 'lang:pm_subject', 'required|strip_tags|trim|min_length[2]');
            $this->form_validation->set_rules('msg-text', 'lang:pm_text', 'required|html_escape|trim|min_length[2]');
    ...
    public function add_participant($id)
    {
        ...
        $this->form_validation->set_rules('msg-add-participants', 'lang:pm_participant_wrong', 'required|trim|alpha_dash');
        if($this->form_validation->run())
        {
