...
class Thread extends CI_Controller {
    ...
    */
    ...
    public function create($category_id)
    {
        ...
        $this->form_validation->set_rules('thread-title', 'lang:forums_name', 'required|strip_tags|trim');
	      $this->form_validation->set_rules('thread-slug', 'lang:forums_slug', 'required|trim|alpha_dash|is_unique[forums_threads.slug]|strip_tags');
        $this->form_validation->set_rules('thread-post', 'lang:forums_initial_post', 'required|trim|html_escape');
	...
	if( ! $this->config->item('forums_view_anonym'))
	{
        ...
        //check for reply
        $this->form_validation->set_rules('reply-post', 'lang:forums_post', 'required|trim|html_escape');
