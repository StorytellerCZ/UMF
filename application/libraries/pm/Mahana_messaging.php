...
class Mahana_messaging
{
    ...
    public function __construct()
    {
        ...
        // ------------------------------------------------------------------------
        //require_once dirname(__FILE__).'/../config/umf/mahana.php';
        
        $this->ci->load->model('pm/Mahana_model');
        $this->ci->load->helper('language');
        $this->ci->lang->load('pm/mahana');
    }
    ...
    /**
     * usernames_to_ids() - takes username or array of usernames and finds the users id
     *
     * @param string/array $usernames REQUIRED
     * @return integer/array
     */
    function usernames_to_ids($usernames)
    {
        ...
        {
            $user = $this->ci->Account_model->get_by_username($usernames);
            if(isset($user->id))
            {
                return $user->id;
            }
